...
var queue = new Queue(queueRef, function(data, progress, resolve, reject) {
  ...
  if (queueItem.name == "ORDER_DETAILS") {
    ...
    config.query('INSERT INTO sales_order (outlet_id, time, counter_code, method, mobile_num, cardholder_name, card_no)\
      VALUES($1, now(), $2, $3, $4, $5, $6) \
      RETURNING id',
      [outlet_id, counter_code, payment_method, mobile_num, cardholder_name, credit_card_no],
      function(query_err, result) {
        if(query_err) {
