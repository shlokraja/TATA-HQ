              ...
              if (rowslength > 0)
              {
                  ...
                  if (previous_order_histoty.order_history != null)
                  {
                      for (var i = 0; i < previous_order_histoty.order_history.order_history.length; i++)
                      {
                          ...
                          if (new Date(order_date) >= new Date(currentdate) && previous_order_histoty.order_history.order_history[i].bill_no == bill_no && (previous_order_histoty.order_history.order_history[i].status == "Dispensing" || previous_order_histoty.order_history.order_history[i].status == "Partially Delivered"))
                          {
