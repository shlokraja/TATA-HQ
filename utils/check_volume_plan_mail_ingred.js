            ...
            function (query_err, result) {
                ...
                if (result.rows.length <= 0) {
                    ...
                    Object.keys(restaurant_data).map(function (key) {
                        ...
                        // rest_content += '<tbody>'
                        rest_content += '<table border="1" class="table table-hover" style="border-collapse: collapse;width:450px"><tr style="background-color: #43b02a;color: #ffffff;font-weight: bold;text-align:center;"><th style="width: 100px;height: 30px;">Session</th><th style="width: 500px;height: 30px;">Ingredient Name</th><th style="width: 100px;height: 30px;">Quantity</th><th style="width: 100px;height: 30px;">UOM</th></tr>';
